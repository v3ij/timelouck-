...
import { Shield, School, ArrowRight, Lock, Users } from 'lucide-react';
...
const LandingSelection = () => {
    ...
    return (
        <div className="min-h-screen bg-[#0A1F44] flex flex-col items-center justify-center p-4 relative overflow-hidden font-sans">
            {/* Background Effects */}
            ...
            <div className="z-10 text-center mb-12">
                ...
                <p className="text-slate-400 text-lg max-w-2xl mx-auto">
                    Secure Entry Portal v3.0 (Emergency Recovery Mode)
                </p>
            </div>
